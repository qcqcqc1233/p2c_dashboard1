    ...
    return (
      <div className="glass-card rounded-xl p-4 flex flex-wrap items-center gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-foreground bg-white/[0.04] border border-white/[0.1] hover:bg-white/[0.07] transition-colors"
        >
    ...
    <div className="glass-card rounded-xl p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-4">
        ...
        <div className="flex flex-col gap-3">
          <div>
            <label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Filter by touchpoint</label>
            <input
              type="text"
              value={filter}
          ...
          <button
            ...
            className="mt-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-neon-purple to-neon-cyan hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
